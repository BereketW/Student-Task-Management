...
public  class TodoDaoImpl implements tododao {
	...
	private static final String SELECT_TODO_BY_USERNAME = "select id,title,username,description,target_date,is_done from todos where username =? ORDER BY target_date";
	...
	public List<todo>selectAllTodos(String user) {
	    ...
	    try (Connection connection = JDBCUtils.getConnection();
	         ...
	         PreparedStatement preparedStatement = connection.prepareStatement(SELECT_TODO_BY_USERNAME);) {
